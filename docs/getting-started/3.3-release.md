...
- **Air-gapped:** The same installer is used to support air-gapped environment and the vulnerability database is pulled from the customer’s private registry or a local file path.
