...
!!! warning "Important: Environment Variables"
...
!!! info "Prerequisite"
    You must have the [GitHub Copilot Extension](https://marketplace.visualstudio.com/items?itemName=GitHub.copilot) installed.
...
!!! failure "Path Resolution Issues"
